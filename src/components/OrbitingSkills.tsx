...
const iconComponents: Record<string, { component: () => React.JSX.Element; color: string }> = {
  ...
  c: {
      component: () => (
          <svg viewBox="0 0 128 128" className="w-full h-full"><path fill="#03599C" d="M89.34 8.75c-11.23-6.19-25.79-8-38.3-5.36-12.79 2.68-23.83 9.4-32.07 19.33-8.15 9.8-13.41 22.3-14.76 35.8C3.02 71.49 5.01 84.8 10.8 96.1c5.84 11.42 15.3 20.6 26.96 26.3 11.53 5.64 25.1 7.23 37.86 4.54 12.75-2.68 23.83-9.4 32.07-19.33 8.16-9.81 13.41-22.3 14.76-35.8 1.19-12.82-1.34-26.38-7.13-37.8M64.03 119C33.19 119 9 94.81 9 64S33.19 9 64.03 9c30.84 0 55.03 24.19 55.03 55s-24.2 55-55.03 55"/><path fill="#03599C" d="M96.79 73.25c-3.15-5.93-8.85-10-15.82-11.45 2.1-2.06 3.51-4.8 3.92-7.85.5-3.69-.5-7.3-2.65-10.22-2.16-2.92-5.35-4.89-8.94-5.5-3.59-.62-7.23.1-10.22 1.94-2.99 1.85-5.11 4.74-6.03 8.08-.91 3.35-.47 6.94 1.25 9.89 1.73 2.95 4.56 5.09 7.82 6.13 4.88 1.56 9.38 1.53 13.47.07 1.25-1.56 2.05-3.48 2.3-5.54h-13.3c-1.33.29-2.62.43-3.87.43-4.66 0-8.99-2.14-11.95-5.83-2.96-3.69-4.22-8.39-3.49-13.1.72-4.71 3.4-8.94 7.42-11.91 4.02-2.96 9.04-4.25 14.1-3.56 5.06.69 9.58 3.31 12.69 7.3 3.1 3.99 4.41 9.07 3.65 14.07-.76 5-3.5 9.4-7.66 12.59-2.08 1.59-4.52 2.68-7.1 3.19 7.42-.4 13.71 3.78 16.58 10.33.61 1.39.94 2.92 1.01 4.48.07 1.56-.14 3.11-.64 4.58-1.95 5.75-6.73 9.97-12.7 11.22-5.97 1.25-12.03-.41-16.58-4.1-4.54-3.69-7.2-9.04-7.3-14.7-.1-5.66 2.4-11.08 6.51-14.94 1.34-1.28 2.87-2.34 4.53-3.15-5.56 3.92-8.47 10.4-7.44 17.06.84 5.43 4.56 9.99 9.68 11.95 5.12 1.96 10.98.79 14.9-2.92s6.13-9.05 5.2-14.48c-.66-3.85-2.88-7.18-6.1-9.35z"/></svg>
      ),
      color: '#03599C'
  },
  java: {
